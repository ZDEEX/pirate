...
do
    ...
    cp src/qt/res/icons/zdeex.icns ${PACKAGE_DIR}/Contents/Resources/logo.icns
...
create-dmg --volname "zdeex-qt-mac" --volicon "zcutil/res/logo.icns" --window-pos 200 120 --icon "TreasureChest.app" 200 190  --app-drop-link 600 185 --hide-extension "TreasureChest.app"  --window-size 800 400 --hdiutil-quiet --background zcutil/res/dmgbg.png  zdeex-qt-mac.dmg TreasureChest.app
