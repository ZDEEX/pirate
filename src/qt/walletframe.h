 ...
 * controls into ZDEEXOceanGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to ZDEEXOceanGUI, thus greatly simplifying merges while
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, ZDEEXOceanGUI *_gui = 0);
    ~WalletFrame();
