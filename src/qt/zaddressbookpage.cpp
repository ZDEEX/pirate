    ...
    tab(_tab)
{
    ...
    ui->labelExplanation->setText(tr("These are your ZDEEX z-addresses for receiving payments. It is recommended to use a new receiving z-address for each transaction."));
